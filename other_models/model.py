...
def model_init(num_atoms, num_atom_features, num_pairs_features, max_num_of_bonds, depth,lr,hidden_size,nbdense):
  ...
  dense_1 = tf.keras.layers.Dense(hidden_size, activation="relu",name='Dense1')
  dense_2 = tf.keras.layers.Dense(hidden_size, activation="relu",name="Dense2")
  dense_3 = tf.keras.layers.Dense(hidden_size, activation="relu",name="Dense3")
  dense_4 = tf.keras.layers.Dense(hidden_size, activation="relu",name="Dense4")
  dense_5 = tf.keras.layers.Dense(hidden_size, activation='relu',name="Dense5")
