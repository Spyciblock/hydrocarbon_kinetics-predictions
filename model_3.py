...
def model_init_3(num_atoms, num_atom_features, num_pairs_features, max_num_of_bonds, hidden_size=32, depth=1, batchnorm=0, last_batchnorm=1, init='glorot_uniform', activ='relu'):
  ...
  atom_features = tf.keras.layers.Dense(8*hidden_size, activation=activ, kernel_initializer=init, name="Dense0-1")(input_atom) 
  atom_features = tf.keras.layers.Dense(16*hidden_size, activation=activ, kernel_initializer=init, name="Dense0-2")(atom_features) 
  ...
  dense_1 = tf.keras.layers.Dense(8*hidden_size, activation=activ, kernel_initializer=init, name='Dense1-1')
  dense_2 = tf.keras.layers.Dense(16*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-2")
  dense_3 = tf.keras.layers.Dense(hidden_size, activation=None, kernel_initializer=init, name="Dense1-3")
  dense_4 = tf.keras.layers.Dense(8*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-4")
  dense_5 = tf.keras.layers.Dense(16*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-5")
  dense_6 = tf.keras.layers.Dense(hidden_size, activation=None, kernel_initializer=init, name='Dense1-6')
  dense_7 = tf.keras.layers.Dense(8*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-7")
  dense_8 = tf.keras.layers.Dense(16*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-8")
  dense_9 = tf.keras.layers.Dense(hidden_size, activation=None, kernel_initializer=init, name="Dense1-9")
  dense_10 = tf.keras.layers.Dense(8*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-10")
  dense_11 = tf.keras.layers.Dense(8*hidden_size, activation=activ, kernel_initializer=init, name="Dense1-11")
  ...
  new_input_pairs_2= new_input_pairs
  new_input_pairs= tf.keras.layers.Dense(hidden_size, activation=activ, kernel_initializer=init, name="Dense2-7")(new_input_pairs)   #shape = num_atoms,num_atoms,hidden_size
  new_input_pairs= tf.keras.layers.Dense(hidden_size, activation=activ, kernel_initializer=init, name="Dense2-8")(new_input_pairs)   #shape = num_atoms,num_atoms,hidden_size
  new_input_pairs= tf.keras.layers.Dense(hidden_size, activation=None, kernel_initializer=init, name="Dense2-9")(new_input_pairs)   #shape = num_atoms,num_atoms,hidden_size
  new_input_pairs = tf.keras.layers.Add()([new_input_pairs, new_input_pairs_2])
  new_input_pairs = tf.keras.layers.ReLU()(new_input_pairs)
  if batchnorm == 1:
  ...
  midlayer = tf.keras.layers.ReLU()(midlayer)
  midlayer = tf.keras.layers.Dense(hidden_size, activation=activ, kernel_initializer=init, name="Dense3-7")(midlayer)      #shape = num_atoms,num_atoms,hidden_size
  midlayer = tf.keras.layers.Dense(hidden_size, activation=activ, kernel_initializer=init, name="Dense3-8")(midlayer)      #shape = num_atoms,num_atoms,hidden_size
  midlayer = tf.keras.layers.Dense(hidden_size, activation=None, kernel_initializer=init, name="Dense3-9")(midlayer)      #shape = num_atoms,num_atoms,hidden_size
  midlayer = tf.keras.layers.Add()([midlayer, concat])
  midlayer = tf.keras.layers.ReLU()(midlayer)
  if batchnorm == 1:
